...
export function AppLogo() {
  ...
  return (
    <div className="transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-8 h-10 flex items-center ml-2 justify-between flex-col">
